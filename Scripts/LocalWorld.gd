...
func set_correct_street_asset():
	...
	if top_street and !bottom_street and !left_street and !right_street:
		...
		position_correction = TilesInterface.tileCoords_to_trueCoords(Vector2i(12, 12))
		...
		position_correction = TilesInterface.tileCoords_to_trueCoords(Vector2i(12, 0))
		streets_insts.append(street_1_inst)
	elif !top_street and !bottom_street and !left_street and right_street:
		var street_1_inst = street_1_scene.instantiate()
		street_1_inst.rotation_degrees = 270
		position_correction = TilesInterface.tileCoords_to_trueCoords(Vector2i(0, 12))
		streets_insts.append(street_1_inst)
	...
	var street_position = (TilesInterface.LOCAL_SIZE_TILES-12)/2
